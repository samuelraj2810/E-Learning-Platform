...
const VericicationPage = () => {
  return (
    ...
    <img src={verifyBg} alt='Verification Page' className='h-fit w-fit lg:h-4/5 lg:w-4/5 absolute object-contain bottom-0'/>
        ...
        <h1 className='z-40 lg:text-3xl mt-10' >Click <Link to="/" className='text-Primary underline underline-offset-8 '>here</Link> to login</h1>
    </div>
  )
}
