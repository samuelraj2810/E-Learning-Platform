...
const ForgotPassword = () => {
    ...
    return (
        <div className='h-screen w-screen bg-gray-100 flex flex-col items-center justify-center'>
            ...
            <h2 className="text-2xl z-10 flex items-center gap-2 font-mono p-2 my-8 md:text-[40px] font-bold tracking-wider">Forgot <span className='text-lg px-2 py-1 bg-red-100 border-2 border-red-300 rounded-r-lg text-red-400 uppercase'>Password</span></h2>
                ...
                />
                <CustomButton title="Submit" loading={loading} size='large' className=' float-end font-bold' color='solid' onClick={handleSubmit}>Submit</CustomButton>
                </div>
            </form>
        </div>
    );
