...
const Mentors = () => {
  ...
  return (
    <div className="w-[90%] m-auto h-fit py-4">
      ...
      <div className="mx-auto rounded-lg flex flex-col md:flex-row flex-wrap gap-10 md:justify-center lg:justify-around mt-10 ">
        {mentorsList.map((each) => (
          <div className="p-2 text-sm rounded-lg md:text-base capitalize flex lg:flex-col lg:gap-10 md:w-2/5 lg:w-fit lg:p-4">
            ...
            />
            <div className="w-full border bg-white lg:hover:shadow-lg scale-100 transition-all duration-500 lg:p-2 rounded-lg">
              ...
              <p className="text-xl w-4/5 md:w-full">{each.name}</p>
            </div>
          </div>
        ))}
      </div>
