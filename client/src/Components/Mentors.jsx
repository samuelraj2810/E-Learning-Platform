...
const Mentors = () => {
  ...
  return (
    <div className="w-[90%] m-auto">
      ...
      <div className="mx-auto flex flex-col md:flex-row flex-wrap gap-10 md:justify-center lg:justify-around">
        {mentorsList.map((each) => (
          <div className="p-2 text-sm rounded-lg md:text-base capitalize flex lg:flex-col lg:gap-10 md:w-2/5 lg:w-fit lg:p-4">
            <img
              src={each.image}
              alt="mentors"
              className="border-8 border-white bg-gray-400 hover:scale-105 transition-all duration-500 hover:bg-gray-100 object-cover shadow-md rounded-full h-20 w-20 md:h-40 md:w-40 lg:h-60 lg:w-60 mr-2 lg:mr-0"
            />
